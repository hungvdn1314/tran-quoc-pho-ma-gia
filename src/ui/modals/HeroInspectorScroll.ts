...
export class HeroInspectorScroll {
  ...
  private getHeroPortraitUrl(heroId: string): string {
    const actorMap: Record<string, string> = {
      trieu_van: 'images/actor_trieu_van.webp',
      truong_lieu: 'images/actor_to_kien_phong.webp',
      cao_thuan: 'images/actor_cao_thuan.webp',
      dien_vi: 'images/actor_dien_vi.webp',
      co_hu: 'images/actor_gia_hu.webp',
      dieu_thuyen: 'images/actor_assassin.webp'
    };
    return actorMap[heroId] || `images/actor_${heroId}.webp`;
  }
