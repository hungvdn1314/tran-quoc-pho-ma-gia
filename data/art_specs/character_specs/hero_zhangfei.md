# HỒ SƠ TẠO HÌNH: TRƯƠNG PHI
- **Mã Định Danh (ID)**: `hero_zhangfei`
- **Danh Xưng / Tự**: Zhang Fei, Trương Dực Đức
- **Phẩm Chất (Rarity)**: [SSR]
- **Binh Chủng**: U Châu Mãnh Kỵ
- **Cảnh Giới Võ Học**: Hoàng Cảnh Cao Kỳ
- **Chỉ Số Tứ Duy**: Võ 98 · Thống 86 · Trí 33 · Chính 22
...
## 3. Khí Giới & Tuyệt Kỹ
- **Tiếng Hét Trường Bản** (Tuyệt Kỹ Chủ Động): Thét vang làm vỡ mật tướng địch, làm choáng toàn làn đối diện.
- **Mãnh Khí Đột Trận** (Kỹ Năng Bị Động): Tăng mạnh tỷ lệ bạo kích khi xông pha trận mạc.
- **Cuồng Chiến Bất Khuất** (Kỹ Năng Bị Động): Máu càng thấp, đòn đánh càng hung bạo.
