# HỒ SƠ TẠO HÌNH: TƯ MÃ Ý
- **Mã Định Danh (ID)**: `hero_simayi`
- **Danh Xưng / Tự**: Sima Yi, Tư Mã Trọng Đạt, Trủng Hổ
- **Phẩm Chất (Rarity)**: [SSR]
- **Binh Chủng**: U Minh Trủng Hổ Vệ
- **Cảnh Giới Võ Học**: Hoàng Cảnh Đỉnh Phong
- **Chỉ Số Tứ Duy**: Võ 63 · Thống 98 · Trí 98 · Chính 93
...
## 3. Khí Giới & Tuyệt Kỹ
- **Ưng Thị Lang Cố** (Tuyệt Kỹ Chủ Động): Ánh mắt lang sói phong tỏa chiêu thức của toàn bộ đối phương.
- **Ẩn Nhẫn Đợi Thời** (Kỹ Năng Bị Động): Phòng thủ kiên cố như bàn thạch không thể công phá.
