# HỒ SƠ TẠO HÌNH: NGỤY DIÊN
- **Mã Định Danh (ID)**: `hero_weiyan`
- **Danh Xưng / Tự**: Wei Yan, Ngụy Văn Trường
- **Phẩm Chất (Rarity)**: [SR]
- **Binh Chủng**: Tý Ngọ Đột Kích Kỵ
- **Cảnh Giới Võ Học**: Vương Cảnh
- **Chỉ Số Tứ Duy**: Võ 89 · Thống 82 · Trí 69 · Chính 45
...
## 3. Khí Giới & Tuyệt Kỹ
- **Tý Ngọ Cốc Kỳ Mưu** (Tuyệt Kỹ Chủ Động): Tập kích tập hậu quân địch gây rối loạn hàng ngũ.
- **Cuồng Cốt Huyết Chiến** (Kỹ Năng Bị Động): Hút sinh lực đối phương qua từng đòn chém.
