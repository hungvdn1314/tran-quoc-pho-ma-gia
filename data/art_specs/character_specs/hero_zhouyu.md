# HỒ SƠ TẠO HÌNH: CHU DU
- **Mã Định Danh (ID)**: `hero_zhouyu`
- **Danh Xưng / Tự**: Zhou Yu, Chu Công Cẩn, Mỹ Chu Lang
- **Phẩm Chất (Rarity)**: [SSR]
- **Binh Chủng**: Giang Đông Thủy Doanh
- **Cảnh Giới Võ Học**: Hoàng Cảnh Đỉnh Phong
- **Chỉ Số Tứ Duy**: Võ 71 · Thống 96 · Trí 96 · Chính 86

---

## 1. Dáng Vóc & Tỷ Lệ Cơ Thể (Silhouette & Proportions)
- **Tỷ lệ đầu**: 7.5 đầu (Mưu thần / Quân vương nho nhã)
...
## 3. Khí Giới & Tuyệt Kỹ
- **Hỏa Thiêu Xích Bích** (Tuyệt Kỹ Chủ Động): Phóng hỏa toàn bộ chiến trường thiêu rụi chiến thuyền và thiết giáp.
- **Anh Tư Táo Phát** (Kỹ Năng Bị Động): Luôn được ra đòn trước tiên trong mỗi hiệp.
