# HỒ SƠ TẠO HÌNH: LỮ BỐ
- **Mã Định Danh (ID)**: `hero_lubu`
- **Danh Xưng / Tự**: Lu Bu, Lữ Phụng Tiên, Vô Song Chiến Thần, Phi Tướng
- **Phẩm Chất (Rarity)**: [UR]
- **Binh Chủng**: Tinh Châu Thiết Kỵ
- **Cảnh Giới Võ Học**: Đế Cảnh
- **Chỉ Số Tứ Duy**: Võ 100 · Thống 87 · Trí 26 · Chính 13
...
## 3. Khí Giới & Tuyệt Kỹ
- **Vô Song Loạn Vũ** (Tuyệt Kỹ Chủ Động): Múa kích cuồng bạo hủy diệt toàn bộ quân địch trên cả 3 làn.
- **Thiên Hạ Vô Song** (Kỹ Năng Bị Động): Miễn nhiễm mọi hiệu ứng khống chế, câm lặng và choáng.
