# HỒ SƠ TẠO HÌNH: QUAN VŨ
- **Mã Định Danh (ID)**: `hero_guanyu`
- **Danh Xưng / Tự**: Guan Yu, Quan Vân Trường, Mỹ Nhiễm Công
- **Phẩm Chất (Rarity)**: [SSR]
- **Binh Chủng**: Kinh Châu Thủy Bộ Kỵ
- **Cảnh Giới Võ Học**: Hoàng Cảnh Đỉnh Phong
- **Chỉ Số Tứ Duy**: Võ 98 · Thống 95 · Trí 75 · Chính 62
...
- **30% Bản Sắc Binh Chủng**: deep jade green, dark bronze, crimson sash, aged gold.
- **10% Điểm Nhấn Kintsugi**: Viền chỉ vàng nóng chảy và hộ tâm phiến hoàng kim.

---

## 3. Khí Giới & Tuyệt Kỹ
- **Thanh Long Trảm Tướng** (Tuyệt Kỹ Chủ Động): Vung đại đao chém đứt phòng tuyến địch.
- **Uy Chấn Hoa Hạ** (Kỹ Năng Bị Động): Hào khí trấn áp toàn bộ tướng lĩnh địch.
- **Nghĩa Khí Hạo Nhiên** (Kỹ Năng Bị Động): Sĩ khí quân sĩ không bao giờ suy giảm.
